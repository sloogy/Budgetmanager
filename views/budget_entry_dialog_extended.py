...
class CategoryManagementWidget(QWidget):
    ...
    def __init__(self, parent=None, *, conn: sqlite3.Connection, typ: str):
        ...
        self.btn_manage.setMinimumSize(32, 32)
    ...
    def _new_subcategory(self) -> None:
        ...
        cats = self.cat_model.list(self.typ)
        if not cats:
            show_info(self, tr("msg.info"), tr("budget.msg.no_categories_create_main"))
            return
    ...
    def _rename_category(self) -> None:
        ...
        if not cat:
            show_info(self, tr("msg.info"), tr("tab_ui.bitte_zuerst_eine_kategorie"))
            return
...
class BudgetEntryDialogExtended(QDialog):
    ...
    def _validate_and_accept(self) -> None:
        ...
        try:
            ...
            show_warning(self, tr("dlg.hinweis"), tr("dlg.betrag_ist_ungueltig"))
            return
