# 📦 BudgetManager v3.0.1 — Installation, Start & Update
...
| Datei | Wofür |
| --- | --- |
| `BudgetManager_Setup_2.4.0.zip` | Empfohlen, wenn Browser oder Windows den direkten EXE-Download blockieren. |
| `BudgetManager_Setup_2.4.0.exe` | Direkter Installer. |
| `BudgetManager-v2.4.0-portable-windows.zip` | Portable Windows-Version ohne Installation. |
| `BudgetManager-v2.4.0-portable-linux.zip` | Portable Linux-Version. |
| `budgetmanager_2.4.0_Windows_x86_64.lpmodule` | Unsigned LifePlanner-/LiveManager-Modul für Windows. |
| `budgetmanager_2.4.0_Linux_x86_64.lpmodule` | Unsigned LifePlanner-/LiveManager-Modul für Linux. |
...
```powershell
Get-FileHash .\BudgetManager_Setup_2.4.0.exe -Algorithm SHA256
```
...
```powershell
Unblock-File .\BudgetManager_Setup_2.4.0.exe
```
...
1. `BudgetManager_Setup_2.4.0.zip` herunterladen.
2. ZIP entpacken.
3. Optional, aber empfohlen: SHA-256 gegen `SHA256SUMS.txt` prüfen.
4. `BudgetManager_Setup_2.4.0.exe` starten.
...
```powershell
.\BudgetManager_Setup_2.4.0.exe /VERYSILENT /SUPPRESSMSGBOXES /NORESTART /DIR="C:\Programme\BudgetManager" /DATA_DIR="D:\BudgetManagerDaten" /LANG=german
```
...
1. `BudgetManager-v2.4.0-portable-windows.zip` herunterladen.
...
1. `BudgetManager-v2.4.0-portable-linux.zip` herunterladen und entpacken.
2. Starten:
