...
class DatabaseManagementDialog(QDialog):
    ...
    def __init__(
        ...
        # v2.2.16 (K4): active_user fuer die Sicherheitsabfrage vor dem Reset –
        # der Reset lief bisher an der Re-Auth aus v2.2.10 vorbei.
    ...
    def _init_ui(self):
        ...
        self.stats_text.setAccessibleName(tr("a11y.database_statistics"))
    ...
    def _reset_database(self):
        ...
        # v2.2.16 (K4): destruktivste Aktion der App – Code-Abfrage wie bei
        # Export/Import/Restore (nur PIN/Passwort; Quick laeuft durch).
        from views.reauth import require_reauth

        if not require_reauth(self, self.active_user, "reset"):
            return
