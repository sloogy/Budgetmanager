# 📦 BudgetManager v2.2.70 — Installation, Start & Update
...
| Datei | Wofür |
| --- | --- |
| `BudgetManager_Setup_2.2.70.zip` | Empfohlen, wenn Browser oder Windows den direkten EXE-Download blockieren. |
| `BudgetManager_Setup_2.2.70.exe` | Direkter Installer. |
| `BudgetManager-v2.2.70-portable-windows.zip` | Portable Windows-Version ohne Installation. |
| `BudgetManager-v2.2.70-portable-linux.zip` | Portable Linux-Version. |
| `budgetmanager_2.2.70_Windows_x86_64.lpmodule` | Unsigned LifePlanner-/LiveManager-Modul für Windows. |
| `budgetmanager_2.2.70_Linux_x86_64.lpmodule` | Unsigned LifePlanner-/LiveManager-Modul für Linux. |
...
```powershell
Get-FileHash .\BudgetManager_Setup_2.2.70.exe -Algorithm SHA256
```
...
```powershell
Unblock-File .\BudgetManager_Setup_2.2.70.exe
```
...
1. `BudgetManager_Setup_2.2.70.zip` herunterladen.
2. ZIP entpacken.
3. Optional, aber empfohlen: SHA-256 gegen `SHA256SUMS.txt` prüfen.
4. `BudgetManager_Setup_2.2.70.exe` starten.
...
```powershell
.\BudgetManager_Setup_2.2.70.exe /VERYSILENT /SUPPRESSMSGBOXES /NORESTART /DIR="C:\Programme\BudgetManager" /DATA_DIR="D:\BudgetManagerDaten" /LANG=german
```
...
1. `BudgetManager-v2.2.70-portable-windows.zip` herunterladen.
...
1. `BudgetManager-v2.2.70-portable-linux.zip` herunterladen und entpacken.
2. Starten:
