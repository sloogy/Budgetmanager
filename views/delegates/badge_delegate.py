...
class BadgeDelegate(QStyledItemDelegate):
    ...
    Erwartet:
      - item text: z.B. "Einnahmen" / tr("kpi.expenses") / tr("typ.Ersparnisse")
    ...
    def paint(self, painter: QPainter, option, index) -> None:
        ...
        if not bg_hex:
            ...
            aliases = {
                tr("kpi.income"): ["Einnahmen", "Income"],
                "Einnahmen": [tr("kpi.income"), "Income"],
                tr("kpi.expenses"): ["Expenses", "Expense"],
                tr("typ.Ersparnisse"): ["Sparen", "Savings"],
            }
