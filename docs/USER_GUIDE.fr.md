# BudgetManager 3.0.2 – Manuel utilisateur

Ce manuel décrit les fonctions réellement disponibles dans la version 3.0.2. BudgetManager conserve les données localement, ne crée aucune écriture sans validation et sépare **budget (prévision)** et **suivi (opérations réelles)**.
