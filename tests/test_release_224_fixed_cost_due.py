...
def test_not_due_yet_in_current_month_is_not_open():
    o, rest = is_open_this_month(
        is_fix=True, is_recurring=True, budget=1410, booked=0, due_day=25,
        year=2026, month=7, today=date(2026, 7, 3),
    )
    assert o is False
    assert rest == 0.0
...
def test_due_reached_in_current_month_is_open():
    o, rest = is_open_this_month(
        is_fix=True, is_recurring=True, budget=1410, booked=0, due_day=25,
        year=2026, month=7, today=date(2026, 7, 25),
    )
    assert o is True
    assert rest == 1410.0
...
def test_past_month_always_due_regardless_of_day():
    o, _ = is_open_this_month(
        is_fix=True, is_recurring=True, budget=1410, booked=0, due_day=25,
        year=2026, month=5, today=date(2026, 7, 3),
    )
    assert o is True
...
def test_already_booked_is_not_open():
    o, _ = is_open_this_month(
        is_fix=True, is_recurring=True, budget=1410, booked=1410, due_day=25,
        year=2026, month=7, today=date(2026, 7, 26),
    )
    assert o is False
...
def test_xor_recurring_partial_booking_open_after_due():
    ...
    o, rest = is_open_this_month(
        is_fix=False, is_recurring=True, budget=200, booked=50, due_day=10,
    ...
    o2, _ = is_open_this_month(
        is_fix=False, is_recurring=True, budget=200, booked=50, due_day=10,
        year=2026, month=7, today=date(2026, 7, 5),
    )
    assert o2 is False
...
def test_no_budget_no_flags_is_never_open():
    o, _ = is_open_this_month(
        is_fix=False, is_recurring=True, budget=0, booked=0, due_day=1,
        year=2026, month=5, today=date(2026, 7, 3),
    )
    assert o is False
