# BudgetManager 3.0.2 – User guide

This guide describes the functions actually available in version 3.0.2. BudgetManager stores data locally, never books without confirmation, and separates **budget (plan)** from **tracking (real transactions)**.
