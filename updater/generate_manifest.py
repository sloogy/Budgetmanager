...
Beispiel (Windows + Linux ZIPs):
  ...
  python -m updater.generate_manifest \
    ...
    --release-tag v2.5.0 \
    --channel stable \
    --windows-zip dist/BudgetManager-v2.5.0-portable-windows.zip \
    --linux-zip dist/BudgetManager-v2.5.0-portable-linux.zip \
    --base-url https://github.com/sloogy/Budgetmanager/releases/download/v2.5.0 \
    --out latest.json
