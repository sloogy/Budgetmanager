...
2. Entweder `BudgetManager_Setup_2.4.0.exe` (Installer) starten **oder** `BudgetManager-v2.4.0-portable-windows.zip` entpacken.
...
Fertiges Paket `BudgetManager-v2.4.0-portable-linux.zip` entpacken und starten:
