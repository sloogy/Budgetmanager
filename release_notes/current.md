...
- Reproduzierbarer `release-trigger/vX.Y.Z`-Vorlauf ergänzt: Versionsdateien werden synchronisiert, `main` wird nur per Fast-Forward übernommen und Release-Tags werden niemals überschrieben.
